...
export async function loadSpotsInBounds(bounds) {
  ...
  const countryCenters = {
    ...
    // Additional countries from Hitchmap
    AD: { lat: 42.5, lon: 1.5 }, AE: { lat: 23.4, lon: 53.8 },
    AF: { lat: 33.9, lon: 67.7 }, AO: { lat: -11.2, lon: 17.9 },
    AZ: { lat: 40.1, lon: 47.6 }, BD: { lat: 23.7, lon: 90.4 },
    BJ: { lat: 9.3, lon: 2.3 }, BN: { lat: 4.5, lon: 114.7 },
    BT: { lat: 27.5, lon: 90.4 }, BZ: { lat: 17.2, lon: -88.5 },
    CI: { lat: 7.5, lon: -5.5 }, CM: { lat: 7.4, lon: 12.4 },
    CV: { lat: 16.0, lon: -24.0 }, CY: { lat: 35.1, lon: 33.4 },
    DJ: { lat: 11.6, lon: 43.1 }, DM: { lat: 15.4, lon: -61.4 },
    DO: { lat: 18.7, lon: -70.2 }, DZ: { lat: 28.0, lon: 1.7 },
    EH: { lat: 24.2, lon: -12.9 }, ER: { lat: 15.2, lon: 39.8 },
    FK: { lat: -51.8, lon: -59.6 }, FO: { lat: 61.9, lon: -6.9 },
    GD: { lat: 12.1, lon: -61.7 }, GF: { lat: 3.9, lon: -53.1 },
    GG: { lat: 49.5, lon: -2.5 }, GI: { lat: 36.1, lon: -5.4 },
    GL: { lat: 71.7, lon: -42.6 }, GP: { lat: 16.3, lon: -61.6 },
    GS: { lat: -54.3, lon: -36.6 }, GY: { lat: 4.9, lon: -58.9 },
    HN: { lat: 15.2, lon: -86.2 }, HT: { lat: 19.1, lon: -72.3 },
    IM: { lat: 54.2, lon: -4.5 }, IQ: { lat: 33.2, lon: 43.7 },
    JE: { lat: 49.2, lon: -2.1 }, KP: { lat: 40.3, lon: 127.5 },
    KW: { lat: 29.3, lon: 47.5 }, LI: { lat: 47.2, lon: 9.6 },
    LS: { lat: -29.6, lon: 28.2 }, MC: { lat: 43.7, lon: 7.4 },
    ML: { lat: 17.6, lon: -4.0 }, MQ: { lat: 14.6, lon: -61.0 },
    MR: { lat: 21.0, lon: -10.9 }, MS: { lat: 16.7, lon: -62.2 },
    MT: { lat: 35.9, lon: 14.4 }, MU: { lat: -20.3, lon: 57.6 },
    MW: { lat: -13.3, lon: 34.3 }, MZ: { lat: -18.7, lon: 35.5 },
    NC: { lat: -20.9, lon: 165.6 }, NI: { lat: 12.9, lon: -85.2 },
    PG: { lat: -6.3, lon: 143.9 }, PS: { lat: 31.9, lon: 35.2 },
    QA: { lat: 25.4, lon: 51.2 }, RU: { lat: 61.5, lon: 105.3 },
    SA: { lat: 23.9, lon: 45.1 }, SB: { lat: -9.6, lon: 160.2 },
    SC: { lat: -4.7, lon: 55.5 }, SD: { lat: 12.9, lon: 30.2 },
    SG: { lat: 1.4, lon: 103.8 }, SJ: { lat: 77.6, lon: 16.1 },
    SM: { lat: 43.9, lon: 12.4 }, SO: { lat: 5.2, lon: 46.2 },
    SR: { lat: 3.9, lon: -56.0 }, SV: { lat: 13.8, lon: -88.9 },
    SY: { lat: 34.8, lon: 38.5 }, SZ: { lat: -26.5, lon: 31.5 },
    TG: { lat: 8.6, lon: 1.2 }, TL: { lat: -8.9, lon: 125.7 },
    TM: { lat: 39.0, lon: 59.6 }, TO: { lat: -21.2, lon: -175.2 },
    TT: { lat: 10.7, lon: -61.2 }, UG: { lat: 1.4, lon: 32.3 },
    VC: { lat: 12.9, lon: -61.3 }, XZ: { lat: 29.7, lon: 91.1 },
    ZM: { lat: -13.1, lon: 27.8 }, ZW: { lat: -19.0, lon: 29.2 },
  }
