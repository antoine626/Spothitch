...
export const allBadges = [
  ...
  // Streak badges
  {
    ...
    descriptionEn: '7 consecutive days active',
    icon: '🔥',
    image: `${BADGE_IMG_PATH}/streak-7.webp`,
    category: 'streak',
  ...
  },
  {
    ...
    name: 'Passionné',
    nameEn: 'Passionate',
    description: '30 jours de suite actif',
    descriptionEn: '30 consecutive days active',
    icon: '💫',
    image: `${BADGE_IMG_PATH}/streak-30.webp`,
    category: 'streak',
  ...
  },
  {
    ...
    name: 'Incassable',
    nameEn: 'Unstoppable',
    description: '100 jours de suite actif',
    descriptionEn: '100 consecutive days active',
    icon: '⚡',
    image: `${BADGE_IMG_PATH}/streak-100.webp`,
    category: 'streak',
  ...
  },
  {
    ...
    name: 'Immortel',
    nameEn: 'Immortal',
    description: '365 jours de suite actif',
    descriptionEn: '365 consecutive days active',
    icon: '🌟',
    image: `${BADGE_IMG_PATH}/streak-365.webp`,
    category: 'streak',
